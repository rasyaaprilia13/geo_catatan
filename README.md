...
langkah-langkah : 
- modifikasi catatan_model.dart : menambahkan atribut "type" untuk menyimpan jenis catatan (toko, rumah, kantor)
- modifikasi main.dart : menamahkan fungsi memilih ikon saat longpress dari pengguna untuk meminta input jenis catatan apa dari pengguna
- 
